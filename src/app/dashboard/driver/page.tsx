...
import { MapPin, Navigation, Clock, CheckCircle2, Power, AlertCircle, Phone, MessageSquare } from "lucide-react"
...
export default function DriverApp() {
  ...
  const activeRidesQuery = useMemoFirebase(() => {
    if (!user) return null
    // Drivers look for rides that are Requested (not yet assigned) OR assigned to them
              ...
              {activeRide ? (
                ...
                >
                  ...
                  <div className="flex gap-4">
                    <Button variant="outline" className="flex-1 border-navy h-12"><Phone className="w-4 h-4 mr-2" /> Call</Button>
                    <Button variant="outline" className="flex-1 border-navy h-12"><MessageSquare className="w-4 h-4 mr-2" /> Chat</Button>
                  </div>
